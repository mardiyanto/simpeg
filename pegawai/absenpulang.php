                ...
                echo"
                    <form method='post' action='#' enctype='multipart/form-data'>
                        <div class='form-group'>
                            ...
                            <input type='text' class='form-control' value='$tx[kode_pegawai]' name='kode_pegawai' id='kode_pegawai'  readonly/><br>
                            ...
                            if ($tp) {
                                    ...
                                    echo "<div class='modal-footer'>
                                    <a href='absen.php?aksi=absensi&id_pegawai=$tx[id_pegawai]' class='btn btn-primary'>absenpulang</a>
                                </div>";
                                } 
                            echo"        
                        </div>
